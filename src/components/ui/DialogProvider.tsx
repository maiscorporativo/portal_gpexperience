...
const THEME: Record<DialogType, { bg: string; border: string; iconColor: string; btnBg: string; btnHover: string }> = {
  info:    { bg: '#0d1f35', border: '#1a3a5c', iconColor: '#7bc4e8', btnBg: '#1a3a5c', btnHover: '#245070' },
  success: { bg: '#0d3320', border: '#1a5c38', iconColor: '#4ade80', btnBg: '#1a5c38', btnHover: '#1e7a48' },
  warning: { bg: '#1a1400', border: '#7a4a00', iconColor: '#fbbf24', btnBg: '#7a4a00', btnHover: '#9a5a00' },
  error:   { bg: '#2a0a0a', border: '#7a1a1a', iconColor: '#f87171', btnBg: '#7a1a1a', btnHover: '#9a2a2a' },
  confirm: { bg: '#0d1f35', border: '#1a3a5c', iconColor: '#7bc4e8', btnBg: '#1a3a5c', btnHover: '#245070' },
  danger:  { bg: '#2a0a0a', border: '#7a1a1a', iconColor: '#f87171', btnBg: '#7a1a1a', btnHover: '#9a2a2a' },
};
            ...
            <div style={{ display: 'flex', gap: 10, marginTop: 8, width: '100%' }}>
              {isConfirmType && (
                <button
                  ...
                  onMouseEnter={e => { e.currentTarget.style.background = '#1a3050'; e.currentTarget.style.color = '#b0c0d0'; }}
                  onMouseLeave={e => { e.currentTarget.style.background = '#142030'; e.currentTarget.style.color = '#8899aa'; }}
                >
                  {cancelText}
                </button>
              )}
              <button
                ...
                style={{
                  ...
                  background: type === 'danger'
                    ...
                    : type === 'warning'
                      ? 'linear-gradient(135deg, #f37126, #d45f1a)'
