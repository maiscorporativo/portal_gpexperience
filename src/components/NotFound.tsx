...
export default function NotFound() {
  return (
    ...
    >
      <div style={{ fontSize: 96, fontWeight: 800, color: '#f37126', lineHeight: 1 }}>404</div>
      ...
      <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', justifyContent: 'center', marginTop: 8 }}>
        <Link
          ...
          style={{
            ...
            background: '#f37126', color: '#000', fontWeight: 700, fontSize: 14,
        ...
        <button
          ...
          onMouseOver={e => (e.currentTarget.style.borderColor = '#f37126')}
