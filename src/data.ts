...
export function getTrendingPackages(): TrendingPackage[] {
  return [
    ...
    },
    {
      ...
      ticketDetails: 'Acesso VIP aos lounges de hospitalidade exclusiva (Club House 24). Ingressos de Categoria A para a cerimônia de abertura e para 3 modalidades (Basquete, Atletismo, Natação) à sua escolha.',
    },
    {
      tag: 'PREMIUM',
