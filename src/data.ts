...
export function getTrendingPackages(): TrendingPackage[] {
  return [
    ...
    },
    {
      ...
      ticketDetails: 'Acesso VIP aos louges de hospitalidade On Location (Club House 24). Ingressos de Categoria A para a cerimônia de abertura e para 3 modalidades (Basquete, Atletismo, Natação) à sua escolha.',
    },
    {
      tag: 'PREMIUM',
...
export function getTestimonials(): Testimonial[] {
  return [
    { img: getImg('testimonial_0'), user: 'Fã da NFL', text: 'Assentos incríveis na linha de 50!' },
    { img: getImg('testimonial_1'), user: 'Fã da WrestleMania', text: 'Viajei de longe... Para estar com o E-Mais na WrestleMania 41 😎' },
    { img: getImg('testimonial_2'), user: 'Fã de UFC', text: 'Melhor noite de lutas de todas.' },
    { img: getImg('testimonial_3'), user: 'Fã de Paris 2024', text: 'Descreva sua experiência E-Mais em uma palavra: Impecável.' },
  ];
}
...
export const TESTIMONIALS: Testimonial[] = getTestimonials();
